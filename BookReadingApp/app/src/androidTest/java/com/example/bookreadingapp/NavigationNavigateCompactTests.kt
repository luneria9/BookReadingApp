...
class NavigationNavigateCompactTests {
    @get:Rule
    ...
    fun setUp() {
        ...
        val mockSharedPreferences = PreferenceManager.getDefaultSharedPreferences(context)
        ...
        composeTestRule.setContent {
            BookReadingAppTheme {
                ...
                BookReadingApp(windowSizeClass = WindowWidthSizeClass.Compact, modifier = Modifier, preferences = mockSharedPreferences)
            }
        }
    }
    ...
    fun validateNavBarNavigateLibrary() {
        composeTestRule.onNode(hasClickLabel("bottom nav bar")).onChildren()[1].performClick()
    ...
    fun validateNavBarNavigateSearch() {
        composeTestRule.onNode(hasClickLabel("bottom nav bar")).onChildren()[2].performClick()
    ...
    fun validateNavBarNavigateHome() {
        composeTestRule.onNode(hasClickLabel("bottom nav bar")).onChildren()[1].performClick()
        composeTestRule.onNode(hasClickLabel("bottom nav bar")).onChildren()[0].performClick()
    }
}